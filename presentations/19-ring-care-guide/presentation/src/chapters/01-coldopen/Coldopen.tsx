...
const CATEGORIES = ["02 daily", "03 cleaning", "04 storage", "05 professional"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">戒指保養指南</h1>
          <p className="co-sub">戒指要戴一世，保養好重要。等我介紹戒指嘅日常保養同清潔方法。</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="co-scene">
        <div className="co-number-block">
          ...
          <span className="co-number-label">可以自己保養</span>
          <span className="co-number-sub">定期護理</span>
        </div>
      </div>
    );
  }
