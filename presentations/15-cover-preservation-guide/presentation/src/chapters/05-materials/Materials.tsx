    ...
    return (
      <div className="c4-scene">
        <div className="c4-hook">
          ...
          <h1 className="c4-title">05 materials</h1>
          <p className="c4-sub">了解05 materials的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c4-scene">
        <div className="c4-number-block">
          <div className="c4-highlight-bar">
            ...
            <span className="c4-number-appear">4. 布料避免暴曬</span>
            <span className="c4-rule" />
          </div>
  ...
  return (
    <div className="c4-scene">
      <div className="c4-card">
        <h2 className="c4-card-title">05 materials</h2>
