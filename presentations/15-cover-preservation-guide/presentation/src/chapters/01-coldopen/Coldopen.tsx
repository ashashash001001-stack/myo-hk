...
const CATEGORIES = ["02 cleaning", "03 storage", "04 handling", "05 materials"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">證書套保存指南</h1>
          <p className="co-sub">結婚證書要保存一世。等我話你知正確嘅保存方法同注意事項。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">一世</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">保存期限</span>
          <span className="co-number-sub">好好保存</span>
        </div>
      </div>
    );
  }
