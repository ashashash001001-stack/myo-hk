...
const CATEGORIES = ["02 rent", "03 buy", "04 consider", "05 hybrid"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">租 vs 買婚紗</h1>
          <p className="co-sub">租婚紗定買婚紗好？等我比較兩者嘅價錢、款式同好處。</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="co-scene">
        <div className="co-number-block">
          ...
          <span className="co-number-label">婚紗平均開支</span>
          <span className="co-number-sub">視乎選擇</span>
        </div>
      </div>
    );
  }
