    ...
    return (
      <div className="c1-scene">
        <div className="c1-hook">
          ...
          <h1 className="c1-title">熱轉印技術</h1>
          <p className="c1-sub">了解熱轉印技術的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c1-scene">
        <div className="c1-number-block">
          <div className="c1-highlight-bar">
            ...
            <span className="c1-number-appear">4. 細字都清晰呈現</span>
            <span className="c1-rule" />
          </div>
  ...
  return (
    <div className="c1-scene">
      <div className="c1-card">
        <h2 className="c1-card-title">熱轉印技術</h2>
