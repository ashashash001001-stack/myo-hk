    ...
    return (
      <div className="c3-scene">
        <div className="c3-hook">
          ...
          <h1 className="c3-title">第四章 保養禁忌與注意</h1>
          <p className="c3-sub">了解第四章 保養禁忌與注意的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c3-scene">
        <div className="c3-number-block">
          <div className="c3-highlight-bar">
            ...
            <span className="c3-number-appear">4. 避免噴灑香水</span>
            <span className="c3-rule" />
          </div>
  ...
  return (
    <div className="c3-scene">
      <div className="c3-card">
        <h2 className="c3-card-title">第四章 保養禁忌與注意</h2>
