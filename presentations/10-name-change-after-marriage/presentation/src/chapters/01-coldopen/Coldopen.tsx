...
const CATEGORIES = ["02 reasons", "03 process", "04 documents", "05 timeline"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">婚後改名指南</h1>
          <p className="co-sub">婚後改名要點做？等我話你知改名程序、文件同注意事項。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">6-8</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">星期辦理時間</span>
          <span className="co-number-sub">視乎部門</span>
        </div>
      </div>
    );
  }
