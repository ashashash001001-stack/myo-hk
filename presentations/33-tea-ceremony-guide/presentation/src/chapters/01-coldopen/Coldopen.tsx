...
const CATEGORIES = ["02 prepare", "03 order", "04 kneeling", "05 gifts"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">敬茶儀式指南</h1>
          <p className="co-sub">敬茶係婚禮必備環節。等我話你知敬茶流程、次序同準備事項。</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="co-scene">
        <div className="co-number-block">
          ...
          <span className="co-number-label">位長輩</span>
          <span className="co-number-sub">平均人數</span>
        </div>
      </div>
    );
  }
