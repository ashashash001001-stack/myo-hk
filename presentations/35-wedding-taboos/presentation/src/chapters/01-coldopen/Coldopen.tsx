...
const CATEGORIES = ["02 dates", "03 items", "04 actions", "05 modern"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">結婚禁忌全面睇</h1>
          <p className="co-sub">結婚有好多傳統禁忌。等我話你知常見嘅禁忌同現代化解釋。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">20+</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">個常見禁忌</span>
          <span className="co-number-sub">傳統習俗</span>
        </div>
      </div>
    );
  }
