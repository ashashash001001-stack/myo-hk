    ...
    return (
      <div className="c3-scene">
        <div className="c3-hook">
          ...
          <h1 className="c3-title">04 actions</h1>
          <p className="c3-sub">了解04 actions的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c3-scene">
        <div className="c3-number-block">
          <div className="c3-highlight-bar">
            ...
            <span className="c3-number-appear">4. 唔好打爛嘢</span>
            <span className="c3-rule" />
          </div>
  ...
  return (
    <div className="c3-scene">
      <div className="c3-card">
        <h2 className="c3-card-title">04 actions</h2>
