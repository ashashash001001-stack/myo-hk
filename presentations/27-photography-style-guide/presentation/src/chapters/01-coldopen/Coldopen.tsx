...
const CATEGORIES = ["02 traditional", "03 reportage", "04 fashion", "05 mix"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">婚禮攝影風格指南</h1>
          <p className="co-sub">婚禮攝影風格有好多種。等我介紹傳統、紀實、時尚同混合風格。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">4種</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">主要攝影風格</span>
          <span className="co-number-sub">各有特色</span>
        </div>
      </div>
    );
  }
