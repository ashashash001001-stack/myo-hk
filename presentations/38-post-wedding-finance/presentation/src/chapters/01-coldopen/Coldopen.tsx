...
const CATEGORIES = ["02 joint", "03 budget", "04 debt", "05 savings"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">婚後理財指南</h1>
          <p className="co-sub">婚後理財好重要。等我話你知聯名戶口、預算管理同儲蓄計劃。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">50%</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">夫婦會聯名理財</span>
          <span className="co-number-sub">香港數據</span>
        </div>
      </div>
    );
  }
