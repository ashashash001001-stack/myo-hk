    ...
    return (
      <div className="c1-scene">
        <div className="c1-hook">
          ...
          <h1 className="c1-title">第二章 切割工藝分級</h1>
          <p className="c1-sub">了解第二章 切割grading工藝分級的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c1-scene">
        <div className="c1-number-block">
          <div className="c1-highlight-bar">
            ...
            <span className="c1-number-appear">4. 公主方時尚幾何</span>
            <span className="c1-rule" />
          </div>
  ...
  return (
    <div className="c1-scene">
      <div className="c1-card">
        <h2 className="c1-card-title">第二章 切割grading工藝分級</h2>
