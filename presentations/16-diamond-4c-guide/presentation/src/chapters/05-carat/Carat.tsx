    ...
    return (
      <div className="c4-scene">
        <div className="c4-hook">
          ...
          <h1 className="c4-title">第五章 克拉重量與價格</h1>
          <p className="c4-sub">了解第五章 克拉grading重量與價格的重點</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="c4-scene">
      <div className="c4-card">
        <h2 className="c4-card-title">第五章 克拉grading重量與價格</h2>
        <div className="c4-list">
          <div className="c4-list-item" style={{ animationDelay: `${0}ms` }}>
            ...
            <span>第五章 克拉grading重量與價格基本概念</span>
          </div>
