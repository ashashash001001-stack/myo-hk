...
const CATEGORIES = ["主動聆聽", "表達感受", "每週傾談", "處理衝突"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">婚姻溝通技巧</h1>
          <p className="co-sub">婚姻幸福關鍵在溝通。等我介紹有效溝通技巧同解決衝突方法。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">70%</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">婚姻問題源於溝通</span>
          <span className="co-number-sub">專家研究</span>
        </div>
      </div>
    );
  }
