...
const CATEGORIES = ["02 velvet", "03 linen", "04 comparison", "05 recommend"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">天鵝絨 vs 亞麻證書套</h1>
          <p className="co-sub">天鵝絨定亞麻證書套好？等我比較兩種材質嘅優缺點。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">2種</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">材質選擇</span>
          <span className="co-number-sub">天鵝絨 vs 亞麻</span>
        </div>
      </div>
    );
  }
