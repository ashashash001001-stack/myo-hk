    ...
    return (
      <div className="c1-scene">
        <div className="c1-hook">
          ...
          <h1 className="c1-title">習俗意義</h1>
          <p className="c1-sub">了解習俗意義的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c1-scene">
        <div className="c1-number-block">
          <div className="c1-highlight-bar">
            ...
            <span className="c1-number-appear">4. 傳統習俗代代相傳</span>
            <span className="c1-rule" />
          </div>
  ...
  return (
    <div className="c1-scene">
      <div className="c1-card">
        <h2 className="c1-card-title">習俗意義</h2>
