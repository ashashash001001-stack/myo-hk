...
const CATEGORIES = ["準備工作", "療程安排", "婚禮日", "05 oneWeek"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">新娘護膚時間表</h1>
          <p className="co-sub">新娘護膚要提前幾耐開始？等我話你知最佳護膚時間表。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">6個月</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">護膚黃金期</span>
          <span className="co-number-sub">提前準備</span>
        </div>
      </div>
    );
  }
