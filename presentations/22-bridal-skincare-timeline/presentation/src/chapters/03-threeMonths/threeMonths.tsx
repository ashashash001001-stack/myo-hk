    ...
    return (
      <div className="c2-scene">
        <div className="c2-hook">
          ...
          <h1 className="c2-title">03 threeMonths</h1>
          <p className="c2-sub">了解03 threeMonths的重點</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="c2-scene">
      <div className="c2-card">
        <h2 className="c2-card-title">03 threeMonths</h2>
