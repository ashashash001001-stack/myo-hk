    ...
    return (
      <div className="c4-scene">
        <div className="c4-hook">
          ...
          <h1 className="c4-title">第五章 婚前一周急救護理</h1>
          <p className="c4-sub">了解第五章 婚前一周急救護理的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c4-scene">
        <div className="c4-number-block">
          <div className="c4-highlight-bar">
            ...
            <span className="c4-number-appear">4. 避免辛辣刺激食物</span>
            <span className="c4-rule" />
          </div>
  ...
  return (
    <div className="c4-scene">
      <div className="c4-card">
        <h2 className="c4-card-title">第五章 婚前一周急救護理</h2>
