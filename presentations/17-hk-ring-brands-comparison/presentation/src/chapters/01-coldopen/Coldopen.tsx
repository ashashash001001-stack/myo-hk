...
const CATEGORIES = ["02 highend", "03 midrange", "04 local", "05 online"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">香港戒指品牌比較</h1>
          <p className="co-sub">香港買結婚戒指邊間好？等我比較各大品牌嘅價格同質素。</p>
        </div>
      </div>
    );
  }
      ...
      <div className="co-scene">
        <div className="co-number-block">
          <div className="co-highlight-bar">
            ...
            <span className="co-number-appear">HKk</span>
            <span className="co-rule" />
          </div>
          <span className="co-number-label">戒指平均開支</span>
          <span className="co-number-sub">視乎品牌</span>
        </div>
      </div>
    );
  }
