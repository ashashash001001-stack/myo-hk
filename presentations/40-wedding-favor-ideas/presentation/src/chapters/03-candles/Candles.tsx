    ...
    return (
      <div className="c2-scene">
        <div className="c2-hook">
          ...
          <h1 className="c2-title">第三章 結婚回禮香薰蠟燭</h1>
          <p className="c2-sub">了解第三章 結婚回禮香薰蠟燭的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c2-scene">
        <div className="c2-number-block">
          <div className="c2-highlight-bar">
            ...
            <span className="c2-number-appear">4. 包裝精美有心思</span>
            <span className="c2-rule" />
          </div>
  ...
  return (
    <div className="c2-scene">
      <div className="c2-card">
        <h2 className="c2-card-title">第三章 結婚回禮香薰蠟燭</h2>
