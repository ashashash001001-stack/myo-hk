...
const CATEGORIES = ["02 trial", "03 style", "04 hair", "05 day"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">新娘化妝髮型指南</h1>
          <p className="co-sub">新娘化妝同髮型係婚禮焦點。等我介紹試妝、風格選擇同貼士。</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="co-scene">
        <div className="co-number-block">
          ...
          <span className="co-number-label">化妝髮型開支</span>
          <span className="co-number-sub">試妝包括</span>
        </div>
      </div>
    );
  }
