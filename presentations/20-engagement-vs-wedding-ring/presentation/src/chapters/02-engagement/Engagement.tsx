    ...
    return (
      <div className="c1-scene">
        <div className="c1-hook">
          ...
          <h1 className="c1-title">訂婚戒指</h1>
          <p className="c1-sub">了解訂婚戒指的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c1-scene">
        <div className="c1-number-block">
          <div className="c1-highlight-bar">
            ...
            <span className="c1-number-appear">4. 預算較高約數萬</span>
            <span className="c1-rule" />
          </div>
  ...
  return (
    <div className="c1-scene">
      <div className="c1-card">
        <h2 className="c1-card-title">訂婚戒指</h2>
