    ...
    return (
      <div className="c1-scene">
        <div className="c1-hook">
          ...
          <h1 className="c1-title">02 requirements</h1>
          <p className="c1-sub">了解02 requirements的重點</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="c1-scene">
      <div className="c1-card">
        <h2 className="c1-card-title">02 requirements</h2>
