    ...
    return (
      <div className="c4-scene">
        <div className="c4-hook">
          ...
          <h1 className="c4-title">05 legalization</h1>
          <p className="c4-sub">了解05 legalization的重點</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="c4-scene">
      <div className="c4-card">
        <h2 className="c4-card-title">05 legalization</h2>
