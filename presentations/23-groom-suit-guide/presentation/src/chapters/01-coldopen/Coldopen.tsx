...
const CATEGORIES = ["02 classic", "03 modern", "04 fit", "05 accessories"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">新郎西裝指南</h1>
          <p className="co-sub">新郎西裝要點揀？等我介紹西裝款式、剪裁同配襯技巧。</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="co-scene">
        <div className="co-number-block">
          ...
          <span className="co-number-label">西裝平均開支</span>
          <span className="co-number-sub">豐儉由人</span>
        </div>
      </div>
    );
  }
