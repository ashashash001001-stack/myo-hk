...
const CATEGORIES = ["02 prep", "03 ceremony", "04 group", "05 couple"];
    ...
    return (
      <div className="co-scene">
        <div className="co-hook">
          ...
          <h1 className="co-title">婚紗相必影清單</h1>
          <p className="co-sub">婚紗相有咩一定要影？等我話你知必影shot list同拍攝貼士。</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="co-scene">
        <div className="co-number-block">
          ...
          <span className="co-number-label">張相片</span>
          <span className="co-number-sub">全日拍攝</span>
        </div>
      </div>
    );
  }
