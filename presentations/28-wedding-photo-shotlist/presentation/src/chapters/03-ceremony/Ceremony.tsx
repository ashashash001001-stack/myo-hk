    ...
    return (
      <div className="c2-scene">
        <div className="c2-hook">
          ...
          <h1 className="c2-title">03 ceremony</h1>
          <p className="c2-sub">了解03 ceremony的重點</p>
        </div>
      </div>
    );
  }
      ...
      <div className="c2-scene">
        <div className="c2-number-block">
          <div className="c2-highlight-bar">
            ...
            <span className="c2-number-appear">4. 時間流程要清晰</span>
            <span className="c2-rule" />
          </div>
  ...
  return (
    <div className="c2-scene">
      <div className="c2-card">
        <h2 className="c2-card-title">03 ceremony</h2>
